...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    do{
        ...
        $sql = "INSERT INTO `inventory` (prod_name, brand, prod_descr, quantity, lmd, lmu)" .
                "VALUES ('$name', '$brand', '$descr', '$quantity','$lmd','$userID')";
        ...
        $sql = "INSERT INTO activity (inv_ID, lmd, lmu, ActName, ActDescr, OldVal, NewVal)" .
                "VALUES ('$last_id', '$lmd', '$userID','Added','','0','$quantity')";
